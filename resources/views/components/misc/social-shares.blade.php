<div class="flex items-center gap-x-2">
    <a href="#" class="group/icon">
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g clip-path="url(#clip0_148_3046)">
                <path
    ...
    <a href="#" class="group/icon">
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g clip-path="url(#clip0_148_3050)">
                <path
                    class="group-hover/icon:stroke-accent"
    ...
    <a href="#" class="group/icon">
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g clip-path="url(#clip0_148_3053)">
                <path
                    class="group-hover/icon:stroke-accent"
    ...
    <a href="#" class="group/icon">
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g clip-path="url(#clip0_148_3056)">
                <path class="group-hover/icon:stroke-accent" d="M15 10L11 14L17 20L21 4L3 11L7 13L9 19L12 15" stroke="currentColor" stroke-width="2"
                    stroke-linecap="round" stroke-linejoin="round" />
            </g>
            <defs>
                <clipPath id="clip0_148_3056">
                    <rect width="24" height="24" fill="white" />
                </clipPath>
            </defs>
        </svg>
    ...
    <a href="#" class="group/icon">
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g clip-path="url(#clip0_148_3059)">
                <path class="group-hover/icon:stroke-accent" d="M8 20L12 11" stroke="currentColor" stroke-width="2" stroke-linecap="round"
        ...
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g clip-path="url(#clip0_148_3064)">
                <path
                    ...
                    stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                <path class="group-hover/icon:stroke-accent" d="M3 7L12 13L21 7" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                    stroke-linejoin="round" />
            </g>
            <defs>
