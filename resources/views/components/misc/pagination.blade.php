    ...
    <a href="{{ $prevUrl }}" class="flex items-center opacity-50 cursor-not-allowed group/icon">
        <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g clip-path="url(#clip0_134_1634)">
                ...
                <path class="group-hover/icon:stroke-accent" d="M5.5 12L11.5 18" stroke="#EAEDF3" stroke-width="2"
                    stroke-linecap="round" stroke-linejoin="round" />
                <path class="group-hover/icon:stroke-accent" d="M5.5 12L11.5 6" stroke="#EAEDF3" stroke-width="2"
                    stroke-linecap="round" stroke-linejoin="round" />
            </g>
            <defs>
    ...
    <a href="{{ $nextUrl }}" class="flex items-center group/icon">
        ...
        <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g clip-path="url(#clip0_134_1642)">
                <path class="group-hover/icon:stroke-accent" d="M5.5 12H19.5" stroke="#EAEDF3" stroke-width="2"
                    stroke-linecap="round" stroke-linejoin="round" />
                <path class="group-hover/icon:stroke-accent" d="M13.5 18L19.5 12" stroke="#EAEDF3" stroke-width="2"
                    stroke-linecap="round" stroke-linejoin="round" />
                <path class="group-hover/icon:stroke-accent" d="M13.5 6L19.5 12" stroke="#EAEDF3" stroke-width="2"
                    stroke-linecap="round" stroke-linejoin="round" />
            </g>
            <defs>
